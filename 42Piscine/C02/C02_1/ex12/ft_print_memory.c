...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/27 15:08:36 by emaydogd          #+#    #+#             */
/*   Updated: 2023/03/27 15:08:47 by emaydogd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <unistd.h>
...
void	*ft_print_memory(void *addr, unsigned int size)
{
	...
	while (i <= size)
	{
		...
		ft_print_content_hex(&addr[i], 16);
		i += 16;
	}
	return (addr);
}
...
int	main(void)
{
	...
	printf("%s", (char *)ft_print_memory((void *)str, strlen(str)));
